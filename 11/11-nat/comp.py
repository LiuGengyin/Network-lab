...
if __name__ == '__main__':
    ...
    h2.cmd('route add default gw 10.0.2.2')
    
    n1.cmd('ifconfig n1-eth0 10.0.1.1/24')
    n1.cmd('ifconfig n1-eth1 159.226.39.43/24')
    
    n2.cmd('ifconfig n2-eth0 10.0.2.2/24')
    ...
    n1.cmd('./nat conf1.conf 2> err1.txt &')
    n2.cmd('./nat conf2.conf 2> err2.txt &')
