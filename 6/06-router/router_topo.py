...
if __name__ == '__main__':
    ...
    r1.cmd('./router > router-output.txt 2>&1 &')
...
if __name__ == '__main__':
    ...
    r2.cmd('route add -net 10.0.4.0 netmask 255.255.255.0 gw 10.0.2.2 dev r2-eth1')
    
    r3.cmd('ifconfig r3-eth0 10.0.2.2/24')
    r3.cmd('ifconfig r3-eth1 10.0.4.1/24')
    r3.cmd('route add -net 10.0.3.0 netmask 255.255.255.0 gw 10.0.2.1 dev r3-eth0')
    r3.cmd('route add -net 10.0.1.0 netmask 255.255.255.0 gw 10.0.2.1 dev r3-eth0')
    ...
    for r in (r1, r2, r3):
        ...
        r.cmd('./router > router-output.txt 2>&1 &')
