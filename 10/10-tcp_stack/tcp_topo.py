...
if __name__ == '__main__':
    ...
    #h1.cmd('./tcp_stack server 10001 > dbg/dbg_server.txt 2>&1')
    #h1.cmd('sudo python3 tcp_stack_trans.py server 10001 > dbg/dbg_server.txt 2>&1')
    #h2.cmd('./tcp_stack client 10.0.0.1 10001 > dbg/dbg_client.txt 2>&1')
    #h2.cmd('sudo python3 tcp_stack_trans.py client 10.0.0.1 10001 > dbg/dbg_client.txt 2>&1')
