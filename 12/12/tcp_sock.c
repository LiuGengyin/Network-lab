...
int tcp_sock_read(struct tcp_sock *tsk, char *buf, int len){
    ...
    while(ring_buffer_empty(tsk->rcv_buf)){ //what if received out-of-order packs before?
    ...
    int rlen = min(len, ring_buffer_used(tsk->rcv_buf)); //similarly, what if out-of-order?
